...
func TestParseModel(t *testing.T) {
	...
	require.Equal(t, "string", gm.Fields[2].SqlType)
	require.Equal(t, "_", gm.Fields[2].Scan.Pkg)
	require.Equal(t, "String", gm.Fields[2].Scan.Name)
	require.Equal(t, "deps", gm.Fields[2].Value.Pkg)
	require.Equal(t, "HexToHash", gm.Fields[2].Value.Name)
	...
	require.Equal(t, "_", gm.Fields[3].Scan.Pkg)
	require.Equal(t, "Int64", gm.Fields[3].Scan.Name)
	require.Equal(t, "big", gm.Fields[3].Value.Pkg)
	require.Equal(t, "NewInt", gm.Fields[3].Value.Name)
	...
	require.Equal(t, "string", gm.Fields[4].SqlType)
	require.Equal(t, "_", gm.Fields[4].Scan.Pkg)
	require.Equal(t, "String", gm.Fields[4].Scan.Name)
	require.Equal(t, "deps", gm.Fields[4].Value.Pkg)
	require.Equal(t, "HexToHash", gm.Fields[4].Value.Name)
	...
	require.Equal(t, "", gm.Fields[5].Scan.Pkg)
	require.Equal(t, "", gm.Fields[5].Scan.Name)
	require.Equal(t, "_", gm.Fields[5].Value.Pkg)
	require.Equal(t, "UTC", gm.Fields[5].Value.Name)
}
